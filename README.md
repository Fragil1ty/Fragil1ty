...
I used to be all for custom Powerplans but nowadays, there isn't much point. But if you need to install a custom Powerplan for AMD/X3D, refer to the following: https://github.com/Fragil1ty/Fragil1ty/blob/main/amd.pow </br>
